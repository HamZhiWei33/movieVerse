...
const UserReviewForm = ({ movie, existingReview = "", existingRating = 0, onSubmit }) => {
    const [reviewText, setReviewText] = useState(existingReview);
    const [rating, setRating] = useState(existingRating);
    const [isModified, setIsModified] = useState(false);
    const [textColor, setTextColor] = useState(existingReview ? '#999999' : '#ffffff');
    ...
    const handleRatingChange = (newRating) => {
        setRating(newRating);
        const modified = newRating !== existingRating || reviewText !== existingReview;
        setIsModified(modified);
        setTextColor(modified ? '#ffffff' : '#999999');
    };
        ...
        <div className="user-review-form">
            ...
            <div className="user-review-body">
                <div className="user-review-rating">
                    <img
                        src="/movieVerse/profile/default_profile_pic.png"
                        alt="User Avatar"
