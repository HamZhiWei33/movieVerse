...
const MovieCardList = ({ movie, liked, addedToWatchlist, onLike, onAddToWatchlist, showRatingNumber = false, showBottomInteractiveIcon = false }) => {
      ...
      <div className="movie-details-container-list">
        ...
        {showBottomInteractiveIcon && (
          <div
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <button className="main-button"><FaPlay className="play-icon" />Play Trailer</button>
            <div
              className="iteractive-icon"
              onClick={handleLikeClick}
            >
